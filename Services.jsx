    ...
    const services = [
      {
        title: 'City Tours',
        description:
          'Explore cities with expert guides and immerse yourself in the culture, history, and vibrancy of urban life.',
        image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
      },
      {
        title: 'Adventure Trips',
        description:
          'Experience thrilling outdoor adventures that push your limits and create unforgettable memories.',
        image: 'https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
      },
      {
        title: 'Custom Packages',
        description:
          'Tailored travel experiences designed exclusively to match your preferences and desires.',
        image: 'https://images.unsplash.com/photo-1488646953014-85cb44e25828?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080', // Changed this image
      },
    ];
